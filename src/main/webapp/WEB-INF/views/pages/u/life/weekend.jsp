            ...
            <div class="container">
                ...
                <form action="">
                            ...
                            <div class="mo_booking_time mo_flex right calandar_time_list">
                                ...
                                <c:forEach items="${times}" var="time" varStatus="index">
                                    <label for="bookingTime<c:out value="${time.name}"/>" class="calandar_time_check">
                                        <input type="radio" name="bookingTime" id="bookingTime<c:out value="${time.name}"/>" value="<c:out value="${time.name}"/>">
                    ...
                    <div class="mt50 btn_full tac btn_wrap">
                        ...
                        <button onClick="javascript:bookingValid(); return false;" class="btn_round_l btn">응모하기</button>
                    </div>
                </form>
