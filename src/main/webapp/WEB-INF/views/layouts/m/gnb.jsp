        ...
        <ul class="adm_menulist">
            ...
            <li>
                ...
                <ul class="adm_menulist_sub">
                    ...
                    <li><a href="<c:url value="/m/product/index.do"/>" class="menu_link031<c:if test="${fn:startsWith(currentURI, '/m/product/index')}"> active</c:if>">추천 제품 관리</a></li>
                    <li><a href="<c:url value="/m/exp/index.do"/>" class="menu_link032<c:if test="${fn:startsWith(currentURI, '/m/exp/index')}"> active</c:if>">체험 제품 관리</a></li>
                </ul>
            </li>
