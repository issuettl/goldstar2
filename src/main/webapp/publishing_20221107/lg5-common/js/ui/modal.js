...
vcui.define('ui/modal', ['jquery', 'vcui'], function ($, core) {
    ...
    var Modal = ui('Modal', /** @lends vcui.ui.Modal# */{
        ...
        show: function show() {
            ...
            //BTOCSITE-20437 공통 팝업 수정 start
            lgkorUI.appIsLayerPopup(true);
            self.$el.off('modalhide.bottom').on('modalhide.bottom', function(e) {
                var $this = $(e.currentTarget);
                if ($this.closest('.ui_modal_wrap').siblings('.ui_modal_wrap').length === 0) {
                    lgkorUI.appIsLayerPopup(false);
                }
            });
            //BTOCSITE-20437 공통 팝업 수정 end
        },
