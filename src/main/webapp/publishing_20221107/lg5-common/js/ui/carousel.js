...
vcui.define('ui/carousel', ['jquery', 'vcui'], function ($, core) {
    ...
    var Carousel = core.ui('Carousel', {
        ...
        swipeMove: function swipeMove(event) {
            ...
            //  console.log('verticalSwipeLength::'+verticalSwipeLength);
            //  console.log('swipeLength::'+self.touchObject.swipeLength);

            if (!opt.verticalSwiping && !self.swiping && verticalSwipeLength > 25) {
