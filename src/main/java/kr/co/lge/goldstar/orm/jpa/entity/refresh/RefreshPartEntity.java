 ...
 * 
 */
package kr.co.lge.goldstar.orm.jpa.entity.refresh;
 ...
 */
@Entity(name="refreshPart")
@Table(name="tb_refresh_part")
@Data
public class RefreshPartEntity implements Serializable {
