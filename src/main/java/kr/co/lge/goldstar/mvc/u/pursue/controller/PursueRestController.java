 ...
 * 
 */
package kr.co.lge.goldstar.mvc.u.pursue.controller;
 ...
 *
 */
@RestController("u.PursueRestController")
@RequestMapping(value = "u/pursue")
public class PursueRestController {
	...
	public DataMap answer(@RequestBody List<Integer> answers) {
		...
		try {
			return this.pursueService.memberAnswers(answers);
