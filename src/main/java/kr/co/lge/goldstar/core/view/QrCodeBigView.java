 ...
 *
 */
@Component("QrCodeBigView")
public class QrCodeBigView extends AbstractView {

    public QrCodeBigView() {
    ...
    protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request,
        ...
        //QR 코드 생성 및 출력
        BitMatrix bitMatrix = qrCodeWriter.encode(content, BarcodeFormat.QR_CODE, 205, 205);
